  ...
  return (
    <main className="flex flex-col gap-6">
      ...
      <section className="mx-auto w-full max-w-xl bg-white border rounded-xl shadow-sm p-6 text-center">
        <p className="text-[11px] uppercase tracking-wide text-slate-400 font-semibold">Total de puntos</p>
        <p className="mt-2 text-5xl font-bold text-slate-900">{state.loading ? "..." : state.points}</p>
      ...
      <section className="mx-auto w-full max-w-3xl bg-white border rounded-xl shadow-sm p-4">
        <h2 className="text-sm font-semibold text-slate-800 mb-3">Últimos movimientos</h2>
