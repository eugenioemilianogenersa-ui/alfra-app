...
// Normalizador de teléfono (mismo criterio que en /api/fudo/sync)
    ...
    <div className="p-6 space-y-6 pb-24">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex gap-3 animate-pulse">
          ...
          <div>
            ...
            <p className="text-xs text-amber-700 mt-1">
              Ingresá tu celular para que tus pedidos de Fudo aparezcan
              automáticamente en la app y puedas ver el tracking en vivo.
            </p>
          </div>
        </div>
      )}
        ...
        <form onSubmit={handleSave} className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="text-xs font-bold text-slate-700 flex justify-between">
              Teléfono
              {!hasPhone && (
                <span className="text-red-500 text-[10px] uppercase tracking-wider">
                  Requerido
                </span>
              )}
            </label>
            ...
            <p className="text-[10px] text-slate-400 mt-1">
              Podés escribirlo con o sin +54 9, lo normalizamos automáticamente.
            </p>
          </div>
      ...
      <div className="bg-white rounded-xl border shadow-sm p-5 space-y-3 max-w-3xl">
        ...
        <p className="text-xs text-slate-500">
          Podés recuperar tu contraseña desde acá.
        </p>
        <Link
          href="/recuperar"
